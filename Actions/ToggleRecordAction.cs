...
{
    public class ToggleRecordAction(Manager manager) : AStreamGlassAction(ms_Definition)
    {
        private static readonly ActionDefinition ms_Definition = new("ToggleRecord", "Toggle OBS record and return it's state");
        ...
        public override object?[] Call(object?[] _) => [ m_Manager.ToggleRecord() ];
    }
}
