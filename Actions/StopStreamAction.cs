...
{
    public class StopStreamAction(Manager manager) : AStreamGlassAction(ms_Definition)
    {
        private static readonly ActionDefinition ms_Definition = new("StopStream", "Stop OBS stream");
